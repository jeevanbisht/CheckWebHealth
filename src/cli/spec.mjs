...
export const OPTIONS = {
  ...
  channel: { type: "string", env: "PROBE_CHANNEL", only: ["probe", "sample", "evidence"], desc: "Browser channel: msedge | chrome | chromium." },
  headed: { type: "boolean", env: "PROBE_HEADED", only: ["probe", "sample", "evidence"], desc: "Run headed (visible) for best forensic fidelity." },
  ...
  open: { type: "boolean", only: ["report"], desc: "Open the report in the default browser when done." },
